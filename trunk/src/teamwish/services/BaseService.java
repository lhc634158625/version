...
public class BaseService {
    ...
    public Result<Integer> getRecordCount(PageFilter pf) {
        teamwish.logic.base.Buss baseLogic = new teamwish.logic.base.Buss();
        List<Condition> list = new ArrayList<Condition>();

        return baseLogic.GetRecordCount(pf.getTableName(), pf.getConditions());
    }
