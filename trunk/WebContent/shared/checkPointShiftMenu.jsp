	...
	<section class="sidebar">
		...
		<div id="width_left" class="layui-side">
			...
			<div
				...
				class="menu_top">
				<span id="show_span" style="line-height: 30px;">市际区际检查站</span> <input
			...
			<div id="left_mean_body">	
				<ul id="sType">
					<li><button class="layui-btn" style="background: #4472ca;" onclick="shiftTypeClict(1)">市际</button></li>
					<li><button class="layui-btn" style="background: #4472ca;" onclick="shiftTypeClict(2)">区际</button></li>
				</ul>			
				<ul id="stationType">
				</ul>
			</div>
 ...
 {{#  layui.each(d.datas, function(index, item){ }}
	...
	<script src="../js/IndexDB.js"></script>
		...
		function shiftTypeClict(type) {
			var itemid = whole_pointInfoMap.get("市际区际检查站")+"-"+whole_pointInfoMap.get("辖区")+"-";
			var title="";
			if(type==1){
				itemid += whole_pointInfoMap.get("市际检查站");
				title="市际检查站";
			}
			else if(type==2){
				itemid += whole_pointInfoMap.get("区际检查站");
				title="区际检查站";
			}			
