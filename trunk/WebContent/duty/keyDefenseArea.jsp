		...
		<div id="mainBody">
							...
							<form class="layui-form" action="">
								<div class="layui-inline">
									<div class="layui-input-inline" style="margin-top: 5px;">
										<input type="checkbox" name="like1" lay-skin="primary" id="keyDefense" lay-filter="checkitem"
			...
			<div id="formDiv">
				...
				<form class="layui-form" action="">
					...
					<div class="layui-form-item">
						<label class="layui-form-label">区域及辐射范围</label>
						<div class="layui-input-inline" style="width: 278px;">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline" style="width: 278px;">
							<input type="text" name="radioGroup" id="radioGroup"
								autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
					...
					function() {
						...
						form.on('checkbox(checkitem)', function(obj){    
							...
							if(data.id=="hasArrage" || data.id=="noArrage"){
								...
								map.ReShowMarkByType("keyDefense",showPointType,showHasNo);
							}
							if(data.id=="carOnline" || data.id=="carOutline"){
								var showPointType=0;
								var showHasNo=0;
								var check = document.getElementById("carOnline").checked;
								if(check){
									showHasNo = showHasNo | 2;
								}
								...
								map.ReShowMarkByType("keyDefenseCar",showPointType,showHasNo);
							} 
							if(data.id=="staffOnline" || data.id=="staffOutline"){
								...
								map.ReShowMarkByType("keyDefenseStaff",showPointType,showHasNo);
							}
...
<script type="text/javascript">
	...
	function setCartoMap(fromDate,toDate,strPointId){
		//获取所有的车辆	
...
<script type="text/javascript">
	...
	function CreateHeadHtml(type,title,strDate,isEdit) {
		...
		if(isEdit == 0){
			if(type==1){
				html += "<td colspan='17'>各分局重点防务巡逻安排表("+strDate+")</td>";
			}else if(type==2||type==3){
				html += "<td colspan='17'>"+title+"重点防务巡逻安排表("+strDate+")</td>";
			}
		}else{
			if(type==1){
				html += "<td colspan='16'>各分局重点防务巡逻安排表("+strDate+")</td>";
			}else if(type==2||type==3){
				html += "<td colspan='16'>"+title+"重点防务巡逻安排表("+strDate+")</td>";
			}
		}
		html += "</tr>"
		html += "<tr>";
			...
			if(spanRows>0){
				for(var j=0;j<spanRows;j++){				
					...
					if(typeof(itemPoint.description)!="undefined"){
						...
						html += "<td id='description_"+pageId+"_"+itemPoint.id+"'></td>";
					}
	...
	function modifyStaffAndDeviceMess(id,pageId,timeSpanIdx,strDeviceTypeCode,type,identify) {
		var shiftType=whole_shiftTypeIdMap.get("重点防务班");
	...
	function saveShiftAndDeviceMess(temp,pageId,pointId,stationId) {
		...
		var devicesInfoArr = ["通信,车号;"+nCar+"","通信,代码;"+cCode+"","通信,电台值守组;"+cRidioGroup
							+"","执勤人数,民警;"+nPeople+"","执勤人数,武警;"+nArmed +"","执勤人数,协警;"+nAuxiliary
							+"","携带装备,长枪;"+eLongGun+"","携带装备,短枪;"+eHandGun+""];
