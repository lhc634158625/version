...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<%@ include file="../shared/policeBoxShiftMenu.jsp"%>
		<div id="mainBody">
			...
			<div id="formDiv">
				<div id="formTop">
					<span>汇总统计</span><img src="../images/starlogo.png"><span
						onclick="closeMess()">X</span>
				</div>
				<form class="layui-form" action="">
					<table class='layui-table'><tbody>
					<tr><td rowspan='2'>市际检查站</td><td>人:3000</td></tr>
					<tr><td>车:700</td></tr>
					<tr><td>历史总量:300000</td><td>异常:10</td></tr>
					<tr><td rowspan='2'>区际检查站</td><td>人:3000</td></tr>
					<tr><td>车:700</td></tr>
					<tr><td>历史总量:300000</td><td>异常:10</td></tr>
					</tbody>
					</table>
...
<script type="text/javascript">
	...
	function showTable() {
		...
		html1 += "<li class='layui-this'>检查站</li>"
		...
		html2 += "</div><div class='layui-inline' style='width: 100%;'><div class='tableTitle'>检查站排班安排表</div></div>";
		html2 += "<table class='layui-table' style='text-align: center;'>";
		html2 += "<tbody>";
		html2 += "<tr>";
		html2 += "<td colspan='17'>检查站排班安排表2018-08-27</td>";
		html2 += "</tr>"
		html2 += "<tr>";
		html2 += "<td rowspan='2'>检查站</td>";
		html2 += "<td rowspan='2'>勤务位置</td>";
		html2 += "<td rowspan='2'>组织单位</td>";
		html2 += "<td rowspan='2'>行动日期</td>";
		html2 += "<td rowspan='2'>勤务时段</td>";
		html2 += "<td colspan='2'>带队民警</td>";
