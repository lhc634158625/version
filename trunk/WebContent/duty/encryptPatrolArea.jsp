					...
					function() {
						...
						form.on('checkbox(checkitem)', function(obj){    
							...
							if(data.id=="hasArrage" || data.id=="noArrage"){
								...
								map.ReShowMarkByType("encrypt",showPointType,showHasNo);
							}
							if(data.id=="carOnline" || data.id=="carOutline"){
								...
								map.ReShowMarkByType("encryptCar",showPointType,showHasNo);
							} 
							if(data.id=="staffOnline" || data.id=="staffOutline"){
								...
								map.ReShowMarkByType("encryptStaff",showPointType,showHasNo);
							}
